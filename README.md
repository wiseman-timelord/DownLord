# DownLord
## Status: Beta
- Re-visited 2025/02/03 - Fixed huggingface links, overhauled and upgraded, elsewhere, the pre-release versions are up. I am completing a 6GB download on a bad line, then it will have passed that test, and then there will be full testing, mainly the setup options, and fix anything else, and then release version.
