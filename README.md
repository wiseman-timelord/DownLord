# DownLord
## Status: Beta
- Revisiting 2025/02. Done: Improved, Fixed, and Upgraded. Still needs more testing...
1. Setup menu has not been tested since upgrades.
2. Platforms other than huggingface, remain untested since upgrades.
