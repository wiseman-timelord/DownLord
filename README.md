# DownLord
## Status: Beta
- Revisiting 2025/02. Done: Improved, Fixed, and Upgraded. Now more testing, then, any required fixing, and then final tweaks/improves elsewhere if necessary or of interest.
