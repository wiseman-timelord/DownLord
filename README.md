# DownLord
## Status: Beta
- Re-visited 2025/02/03 - Fixed huggingface links, overhauled and upgraded, elsewhere, the pre-release versions are up. There was a problem with registering the downloads, this investigated, I then persued some other improvements, this lead to additional implementations for things I didnt really see necessary, but apparently enhance the program a little. We are now in a stage of final checks for, logic, sanity, completeness. After which there will be testing, and hopefully only a little fixing, and then a release version, and I can get on with my download from huggingface.
